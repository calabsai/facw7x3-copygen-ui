...
function App() {
  ...
  // Define an array of humorous messages
  const loadingMessages = [
    "🤔 Writer's block? Never heard of it. Stand back—I'm about to work some magic.",
    "🕶️ Channeling my inner Hemingway. Don't worry, I'll leave out the existential angst.",
    "🎲 Rolling the dice on creativity. Fingers crossed for a natural 20 in copywriting!",
    "🧪 Concocting a linguistic potion. Side effects may include uncontrollable awe.",
    "🔥 Turning up the heat in the word kitchen. Careful, this copy's gonna sizzle.",
    "🛸 Abducting ideas from the creative galaxy. Don't worry, they come in peace.",
    "🎯 Aiming for wordplay perfection. Bullseye or bust, here we go!",
    "🦉 Summoning the wise old wordsmiths. They're old-school, but they've got game.",
    "🎩 Doffing my hat to the wordplay aristocracy. We're about to get fancy in here.",
    "🥊 Going toe-to-toe with the muse. It's a creative showdown for the ages."
  ];
